...
public class PlacesAutoCompleteAdapter extends ArrayAdapter<Prediction> implements Filterable {
    ...
    private static class PlacesAutoCompleteFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            try {
                ...
                if (charSequence == null || charSequence.length() == 0) {
                    ...
                    AutoComplete predictions = RetrofitMaps.getPlacesAutoComplete(charSequence.toString(), "restaurant", "fr", context.getString(R.string.google_maps_key)).execute().body();
